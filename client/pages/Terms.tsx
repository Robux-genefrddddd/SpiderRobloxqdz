        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            <section className="space-y-4">
              ...
              <p>
                By accessing and using RbxAssets, you accept and agree to be
            ...
            <section className="space-y-4">
              ...
              <p>
                The materials on RbxAssets are provided on an 'as is' basis.
                RbxAssets makes no warranties, expressed or implied, and hereby
            ...
            <section className="space-y-4">
              ...
              <p>
                The materials appearing on RbxAssets could include technical,
                typographical, or photographic errors. RbxAssets does not
                warrant that any of the materials on the website are accurate,
                complete, or current. RbxAssets may make changes to the
            ...
            <section className="space-y-4">
              ...
              <p>
                RbxAssets has not reviewed all of the sites linked to its
                website and is not responsible for the contents of any such
                linked site. The inclusion of any link does not imply
                endorsement by RbxAssets of the site. Use of any such linked
            ...
            <section className="space-y-4">
              ...
              <p>
                You retain ownership of any content you upload to RbxAssets.
                However, by uploading content, you grant RbxAssets a
                non-exclusive, worldwide, royalty-free license to use, copy,
                distribute, and display your content for the purposes of
            ...
            <section className="space-y-4">
              ...
              <p>
                RbxAssets may terminate your access to the website and services
